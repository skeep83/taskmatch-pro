      ...
      <main className="min-h-screen">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Добро пожаловать в ServiceHub Business, {user?.email}
          </p>
        </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <TabsContent value="overview" className="space-y-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                  <div className="flex flex-col items-center gap-3 text-center">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm text-black">Создать заказ</h3>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex flex-col items-center gap-3 text-center">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm text-black">Инвойсы</h3>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex flex-col items-center gap-3 text-center">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm text-black">Аналитика</h3>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex flex-col items-center gap-3 text-center">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm text-black">Настройки</h3>
                    </div>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="p-8 bg-[#E5E7EB] shadow-[8px_8px_16px_#D1D5DB,-8px_-8px_16px_#F9FAFB] rounded-2xl">
                <h2 className="text-2xl font-semibold mb-4 text-black">Добро пожаловать в ServiceHub Business!</h2>
                <p className="text-muted-foreground mb-6">
                  Управляйте заказами компании, контролируйте расходы и координируйте команду в одном месте.
                </p>
                <div className="space-y-3">
                  <p className="text-sm text-muted-foreground"><strong>1.</strong> Настройте данные компании во вкладке "Компания"</p>
                  <p className="text-sm text-muted-foreground"><strong>2.</strong> Создавайте заказы и отслеживайте прогресс</p>
                  <p className="text-sm text-muted-foreground"><strong>3.</strong> Контролируйте финансы через инвойсы и аналитику</p>
                </div>
              </div>
            </TabsContent>
