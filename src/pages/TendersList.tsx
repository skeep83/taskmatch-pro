          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <TabsContent value="active" className="space-y-8 mt-8">
              ...
              <div className="flex justify-between items-center">
                <h2 className="text-2xl font-display font-bold">Активные тендеры</h2>
            ...
            <TabsContent value="my-bids" className="space-y-8 mt-8">
              <div className="text-center py-12">
                ...
                <h2 className="text-xl font-semibold mb-2">Мои заявки</h2>
                <p className="text-muted-foreground">Здесь будут отображаться ваши заявки на тендеры</p>
              </div>
            </TabsContent>
