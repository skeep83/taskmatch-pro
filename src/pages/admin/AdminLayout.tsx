  ...
  return (
    <div className="min-h-screen bg-neo">
      ...
      <Sheet open={mobileNavOpen} onOpenChange={setMobileNavOpen}>
        <SheetContent side="left" className="w-[88vw] max-w-[360px] border-0 bg-neo p-0">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 py-4 px-4 sm:px-6">
            <div className="flex min-w-0 items-center gap-3 sm:gap-4">
              <button
                ...
                className="lg:hidden inline-flex h-11 w-11 items-center justify-center rounded-xl bg-neo neo-8 text-gray-700"
            ...
            <div className="flex max-w-full flex-wrap items-center justify-end gap-3 sm:gap-4">
              {securityWarnings.length > 0 && (
                <div className="flex items-center gap-2 px-3 py-1 rounded-xl bg-neo neo-inset-4">
              ...
              <div className="flex max-w-full flex-wrap items-center justify-end gap-2">
                {roleBadges.map(role => (
                  <Badge
                    key={role}
                    variant="secondary"
                    className="px-3 py-1 rounded-xl bg-neo neo-inset-4 text-xs font-medium text-gray-700"
                  >
              ...
              <button
                onClick={logout}
                className="flex items-center gap-2 text-sm px-4 py-2 rounded-xl bg-neo neo-8 hover:neo-4 transition-all duration-300 text-gray-700 hover:text-gray-800"
              >
