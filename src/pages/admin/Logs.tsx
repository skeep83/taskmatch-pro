...
function AdminLogs() {
  ...
  const fetchLogs = async () => {
    try {
      ...
      setError('Ошибка при загрузке логов: ' + (err as Error).message);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="logs" className="space-y-6">
        ...
        <TabsContent value="analytics" className="space-y-6">
          <div>Аналитика логов ошибок (в разработке)</div>
        </TabsContent>
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  <div className="text-muted-foreground">
                    ...
                    <p className="text-sm">Попробуйте изменить фильтры или период поиска</p>
                  </div>
                </CardContent>
              </Card>
            ) : (
