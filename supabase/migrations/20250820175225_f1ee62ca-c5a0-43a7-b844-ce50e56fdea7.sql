...
-- Update find_nearby_pros function with proper search_path
...
-- Update auto_set_job_location function with proper search_path
...
-- Update generate_job_otp function with proper search_path  
