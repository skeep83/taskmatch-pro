...
-- Insert default service categories (without specifying ID)
INSERT INTO public.service_categories (name, name_ru, name_ro, icon, is_active, sort_order) VALUES
('Сантехника', 'Сантехника', 'Instalații sanitare', 'wrench', true, 1),
('Электрика', 'Электрика', 'Electricitate', 'zap', true, 2),
('Уборка', 'Уборка', 'Curățenie', 'brush', true, 3),
('Ремонт техники', 'Ремонт техники', 'Reparații aparate', 'settings', true, 4),
('Строительство', 'Строительство', 'Construcții', 'hammer', true, 5)
