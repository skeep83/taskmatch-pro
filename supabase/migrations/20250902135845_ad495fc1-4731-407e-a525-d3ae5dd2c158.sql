...
-- Now add all roles for skeep83@gmail.com with proper casting
INSERT INTO public.user_roles (user_id, role) 
SELECT u.id, unnest(ARRAY['client', 'pro', 'business', 'superadmin', 'ops', 'kyc', 'finance', 'dispute_manager', 'content', 'risk', 'city_manager', 'tender']::app_role[]) 
FROM auth.users u 
