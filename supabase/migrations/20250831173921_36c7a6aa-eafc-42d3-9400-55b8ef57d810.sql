-- Disable audit trigger temporarily, add test data, re-enable
ALTER TABLE public.pro_categories DISABLE TRIGGER ALL;

-- Create minimal test data
INSERT INTO public.pro_profiles (user_id, bio, radius_km, hourly_rate_cents, fixed_price_cents) VALUES
  ('d3117828-1618-4c73-aee1-5968538d95d0', 'Опытный специалист с многолетним стажем работы', 15, 4500, 8000)
...
-- Re-enable triggers
ALTER TABLE public.pro_categories ENABLE TRIGGER ALL;